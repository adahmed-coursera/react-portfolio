...
import { removeFromCart, getCartTotal, toggleCartQty, clearCart } from '../../store/cartSlice';
                    ...
                    cartProducts.map(cartProduct =>(
                      <div className='cart-item grid' key={cartProduct.id}>
                        ...
                        <div className='cart-item-info'>
                          ...
                          <button type="button" className="qty-dec fs-14 text-align-blue" onClick={()=> dispatch(toggleCartQty({id:cartProduct.id, type:'DEC'}))}>
              ...
              <div className='cart-right bg-white'>
                <div className='cart-summary text-light-blue'>
                  <div className='cart-summary-title'>
                    <h6 className='fs-20 fw-5'>Orders Summary</h6>
                  </div>
                  <ul className='cart-summary-info'>
                    <li className='flex flex-between'>
                      <span className='fw-4'>Selected {totalItems} item(s) Price</span>
